        ...
        <div className="flex items-center justify-between h-16">
          ...
          >
            <motion.span 
              ...
              whileTap={{ scale: 0.9 }}
              className="w-8 h-8 rounded-lg bg-blue-600 text-white flex items-center justify-center shadow-xs"
            >
          ...
          <div className="flex md:flex-none md:hidden">
            <motion.button
              whileTap={{ scale: 0.9 }}
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="md:hidden overflow-hidden border-t border-zinc-200 dark:border-zinc-800 space-y-2"
            >
